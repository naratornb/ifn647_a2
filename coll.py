...
if __name__ == '__main__':
    ...
    coll = parse_rcv_coll("/Users/niceenb/Documents/647/wk9_workshop_solution/", stop_words)
    for id, doc in coll.get_docs().items():
        print('Document '+ id + ' contains '+ str(len(doc.get_term_list())) + ' terms and have total ' + str(doc.get_doc_len()) + ' words')
        doc1 = doc.get_term_freq_dict()
